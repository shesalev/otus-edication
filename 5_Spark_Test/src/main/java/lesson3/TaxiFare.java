...
/**
 * A lesson3.TaxiFare has payment information about a taxi ride.
 *
...
public class TaxiFare implements Serializable {
	...
	/**
	 * Creates a lesson3.TaxiFare with now as the start time.
	 */
	public TaxiFare() {
	...
	/**
	 * Creates a lesson3.TaxiFare with the given parameters.
	 */
