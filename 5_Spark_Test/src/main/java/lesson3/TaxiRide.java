...
/**
 * A lesson3.TaxiRide is a taxi ride event. There are two types of events, a taxi ride start event and a
 * taxi ride end event. The isStart flag specifies the type of the event.
 *
 * <p>A lesson3.TaxiRide consists of
...
public class TaxiRide implements Comparable<TaxiRide>, Serializable {
	...
	/**
	 * Creates a new lesson3.TaxiRide with now as start and end time.
	 */
	public TaxiRide() {
	...
	/**
	 * Creates a lesson3.TaxiRide with the given parameters.
	 */
	...
	/**
	 * Compares this lesson3.TaxiRide with the given one.
	 *
	 * <ul>
