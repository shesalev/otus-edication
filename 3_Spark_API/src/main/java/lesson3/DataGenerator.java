...
/**
 * Data generator for the fields in lesson3.TaxiRide and lesson3.TaxiFare objects.
 *
 * <p>Results are deterministically determined by the rideId. This guarantees (among other things)
 * that the startTime for a lesson3.TaxiRide START event matches the startTime for the lesson3.TaxiRide END and
 * lesson3.TaxiFare events for that same rideId.
 */
public class DataGenerator {
	...
	/**
	 * Creates a lesson3.DataGenerator for the specified rideId.
	 */
